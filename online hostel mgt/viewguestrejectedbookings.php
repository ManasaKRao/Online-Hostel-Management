	...
	<section class="contact-wthree py-5" id="contact">
		<div class="container">
			<div class="title text-center">
				<h3 class="title-w3 text-bl text-center font-weight-bold">View Guest Rejected Bookings</h3>
				<div class="arrw">
...
<table id="datatable"  class="table table-striped table-bordered">
	...
	<tbody>
	<?php
	$sql ="SELECT * FROM billing LEFT JOIN guest ON billing.guestid=guest.guestid WHERE billing.status='Rejected' AND billing.bill_type='Guest Payment'";
