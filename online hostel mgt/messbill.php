...
<table  class="table  table-bordered" style="background-color: white;">
	<thead>
		<tr>
			...
			<th>Present</th>
			<th>Absent</th>
			<th>Monthly Room Rent<br><input type="text" name="varroomrent" id="varroomrent" style="width: 75px;" onkeyup="calculatetotal()" onchange="calculatetotal()" value="0"></th>
			<th>Mess Bill<br><input type="text" name="varmessbill" id="varmessbill" style="width: 75px;" onkeyup="calculatetotal()" onchange="calculatetotal()" value="0"></th>
			<th>Water & Electricity Charge<br><input type="text" id="varwaterelectricity" name="varwaterelectricity" style="width: 75px;" onkeyup="calculatetotal()" onchange="calculatetotal()" value="0"></th>
			<th>Maintanance Charge<br><input type="text" id="varmaintanance" name="varmaintanance" style="width: 75px;" onkeyup="calculatetotal()" onchange="calculatetotal()" value="0"></th>
			<th>Total<br><input type="text" id="vartotal" name="vartotal" style="width: 75px; background-color: #efefb3;" onkeyup="calculatetotal()" onchange="calculatetotal()" value="0"></th>
		</tr>
	</thead>
	<tbody>
<?php
